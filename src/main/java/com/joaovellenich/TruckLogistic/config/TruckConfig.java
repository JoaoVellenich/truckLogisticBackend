...
public class TruckConfig {
    @Bean
    public TruckController truckController(CreateTruckUseCase createTruckUseCase, GetTrucksInfoUseCase getTrucksInfoUseCase, GetTrucksInfoDTOMapper getTrucksInfoDTOMapper){
        return new TruckController(createTruckUseCase, getTrucksInfoUseCase, getTrucksInfoDTOMapper);
    }
    @Bean
    ...
    @Bean
    public GetTrucksInfoUseCase getTruckUseCase(TruckGateway truckGateway){
        return new GetTrucksInfoUseCase(truckGateway);
    }
    @Bean
